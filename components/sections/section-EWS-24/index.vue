<template>
  <section class="section-ews24">
    ...
    <div class="container">
      ...
      <div class="case-studies hidden-md-up">
        <div class="container">
  ...
  export default {
    ...
    computed: {
      caseStudies () {
        ...
        for (let i = 0; i < caseStudies.length; i += this.itemsPerSlide) {
          tempCaseStudies.push(caseStudies.slice(i, i + this.itemsPerSlide));
        }
    ...
    @media(max-width: $sm) {
      .card:hover.mobile-hover {
        ...
        .read-more {
          ...
          padding: 0.2rem 2.8rem 0.2rem 1.2rem;
